...
const RouteProtection = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    // ✅ FIX: HASH ROUTER SAFE PATH
    const fullPath = location.pathname + location.hash

    const isAdminRoute = fullPath.includes("/admin")
    const isAuthPage =
      fullPath.includes("/login") ||
      fullPath.includes("/admin/register")
  ...
  }, [user, role, loading, location.pathname, location.hash, navigate, toast])
